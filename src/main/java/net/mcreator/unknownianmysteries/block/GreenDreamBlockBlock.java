...
public class GreenDreamBlockBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:green_dream_block")
	public static final Block block = null;

	public GreenDreamBlockBlock(UnknownianmysteriesModElements instance) {
		super(instance, 117);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(1f, 10f).setLightLevel(s -> 0).harvestLevel(6)
					.harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("green_dream_block");
		}
