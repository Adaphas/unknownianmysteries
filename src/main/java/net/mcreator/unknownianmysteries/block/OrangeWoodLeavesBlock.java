...
public class OrangeWoodLeavesBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:orange_wood_leaves")
	public static final Block block = null;

	public OrangeWoodLeavesBlock(UnknownianmysteriesModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends LeavesBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_wood_leaves");
		}
