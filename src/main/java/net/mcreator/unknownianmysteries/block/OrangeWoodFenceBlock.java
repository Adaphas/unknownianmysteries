...
public class OrangeWoodFenceBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:orange_wood_fence")
	public static final Block block = null;

	public OrangeWoodFenceBlock(UnknownianmysteriesModElements instance) {
		super(instance, 143);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_wood_fence");
		}
