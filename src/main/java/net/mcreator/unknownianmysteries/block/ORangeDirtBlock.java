...
public class ORangeDirtBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:o_range_dirt")
	public static final Block block = null;

	public ORangeDirtBlock(UnknownianmysteriesModElements instance) {
		super(instance, 158);
	}
