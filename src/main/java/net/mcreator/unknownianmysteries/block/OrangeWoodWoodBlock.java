...
public class OrangeWoodWoodBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:orange_wood_wood")
	public static final Block block = null;

	public OrangeWoodWoodBlock(UnknownianmysteriesModElements instance) {
		super(instance, 137);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.WOOD).sound(SoundType.WOOD).hardnessAndResistance(6f, 3.4822022531844965f).setLightLevel(s -> 0)
					.harvestLevel(6).harvestTool(ToolType.AXE).setRequiresTool());
			this.setDefaultState(this.stateContainer.getBaseState().with(AXIS, Direction.Axis.Y));
			setRegistryName("orange_wood_wood");
		}
