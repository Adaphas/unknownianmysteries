...
public class OrangeWoodFenceGateBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:orange_wood_fence_gate")
	public static final Block block = null;

	public OrangeWoodFenceGateBlock(UnknownianmysteriesModElements instance) {
		super(instance, 144);
	}
	...
	public static class CustomBlock extends FenceGateBlock {
		public CustomBlock() {
			...
			setRegistryName("orange_wood_fence_gate");
		}
