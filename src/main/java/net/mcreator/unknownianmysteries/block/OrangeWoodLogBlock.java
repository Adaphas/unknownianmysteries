...
public class OrangeWoodLogBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:orange_wood_log")
	public static final Block block = null;

	public OrangeWoodLogBlock(UnknownianmysteriesModElements instance) {
		super(instance, 138);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("orange_wood_log");
		}
