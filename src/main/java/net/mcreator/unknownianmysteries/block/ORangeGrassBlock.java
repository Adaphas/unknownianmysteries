...
import net.mcreator.unknownianmysteries.procedures.ORangeGrassBlockDestroyedByPlayerProcedure;
...
public class ORangeGrassBlock extends UnknownianmysteriesModElements.ModElement {
	@ObjectHolder("unknownianmysteries:o_range_grass")
	public static final Block block = null;

	public ORangeGrassBlock(UnknownianmysteriesModElements instance) {
		super(instance, 159);
	}
	...
	public static class CustomBlock extends Block {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			ORangeGrassBlockDestroyedByPlayerProcedure.executeProcedure(Stream
