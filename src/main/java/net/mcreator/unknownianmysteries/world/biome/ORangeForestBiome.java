...
import net.mcreator.unknownianmysteries.block.OrangeWoodLogBlock;
import net.mcreator.unknownianmysteries.block.OrangeWoodLeavesBlock;
...
public class ORangeForestBiome extends UnknownianmysteriesModElements.ModElement {
	public static Biome biome;

	public ORangeForestBiome(UnknownianmysteriesModElements instance) {
		super(instance, 158);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(ORangeGrassBlock.block.getDefaultState(),
								ORangeDirtBlock.block.getDefaultState(), ORangeDirtBlock.block.getDefaultState())));
				biomeGenerationSettings.withStructure(StructureFeatures.MINESHAFT);
				biomeGenerationSettings.withStructure(StructureFeatures.BURIED_TREASURE);
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration(
								(new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(OrangeWoodLogBlock.block.getDefaultState()),
										new SimpleBlockStateProvider(OrangeWoodLeavesBlock.block.getDefaultState()),
										new MegaPineFoliagePlacer(FeatureSpread.func_242252_a(0), FeatureSpread.func_242252_a(0),
												FeatureSpread.func_242253_a(3, 4)),
										new GiantTrunkPlacer(6, 2, 14), new TwoLayerFeature(1, 1, 2)))
				...
				event.getRegistry().register(biome.setRegistryName("unknownianmysteries:o_range_forest"));
			}
		}
	}
	...
	private static class CustomLeaveVineTreeDecorator extends LeaveVineTreeDecorator {
		...
		static {
			...
			tdt.setRegistryName("o_range_forest_lvtd");
	...
	private static class CustomTrunkVineTreeDecorator extends TrunkVineTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("o_range_forest_tvtd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
	...
	private static class CustomCocoaTreeDecorator extends CocoaTreeDecorator {
		...
		static {
			codec = com.mojang.serialization.Codec.unit(() -> instance);
			tdt = new TreeDecoratorType(codec);
			tdt.setRegistryName("o_range_forest_ctd");
			ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
		}
