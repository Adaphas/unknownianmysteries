...
public class SuperflatGreenDreamBiome extends UnknownianmysteriesModElements.ModElement {
	public static Biome biome;

	public SuperflatGreenDreamBiome(UnknownianmysteriesModElements instance) {
		super(instance, 117);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				mobSpawnInfo.withSpawner(EntityClassification.MONSTER, new MobSpawnInfo.Spawners(EntityType.SLIME, 20, 4, 4));
				...
				event.getRegistry().register(biome.setRegistryName("unknownianmysteries:superflat_green_dream"));
			}
		}
	}
