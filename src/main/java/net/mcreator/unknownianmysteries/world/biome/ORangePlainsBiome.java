...
public class ORangePlainsBiome extends UnknownianmysteriesModElements.ModElement {
	public static Biome biome;

	public ORangePlainsBiome(UnknownianmysteriesModElements instance) {
		super(instance, 161);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("unknownianmysteries:o_range_plains"));
			}
		}
	}
