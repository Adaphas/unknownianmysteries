...
import net.mcreator.unknownianmysteries.world.dimension.DarkVoidDimension;
...
public class DarkVoidItem extends Item {
	@ObjectHolder("unknownianmysteries:dark_void")
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				DarkVoidDimension.portal.portalSpawn(world, pos);
