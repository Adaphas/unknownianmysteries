...
import net.mcreator.unknownianmysteries.world.dimension.GreenDreamDimension;
...
public class GreenDreamItem extends Item {
	@ObjectHolder("unknownianmysteries:green_dream")
	public static final Item block = null;

	public GreenDreamItem() {
	...
	public ActionResultType onItemUse(ItemUseContext context) {
		...
		if (!entity.canPlayerEdit(pos, context.getFace(), itemstack)) {
			...
			if (world.isAirBlock(pos) && true) {
				GreenDreamDimension.portal.portalSpawn(world, pos);
